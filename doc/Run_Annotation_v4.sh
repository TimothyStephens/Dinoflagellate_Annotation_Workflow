...
python load_EVM_to_SQLite3.py --gff scaffolds_len250kbp.fa.evm.gff3 --protein scaffolds_len250kbp.fa.evm.protein.faa --mrna scaffolds_len250kbp.fa.evm.cds.fna --sql_db $TMPDIR/EVM.gff.sqlite3
python get_filtered_EVM_files.py --filter_file filtered_EVM_predictions.txt --sql_db $TMPDIR/EVM.gff.sqlite3 --gff_out evm.filtered.gff --protein_out evm.filtered.protein.fasta --mrna_out evm.filtered.mRNA.fasta
